...
import { c as createComponent, a as createAstro, m as maybeRenderHead, b as addAttribute, x as spreadAttributes, e as renderTemplate } from '../chunks/astro/server_Bbdr8WX7.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_6K6GS7BG.mjs'
    ).then(n => n.Z).catch((e) => {
